...
const serial_port="COM5"; // change this to your TTL port!
...
function readSerialData(data) {
    ...
    client.publish("grupp4/direction/remote_2", data + '\n' ); //publish data [TOPIC, MESSAGE, OPTIONS]
...
function myTimer1() {
    //console.log('\n' + 'Asking for data!', read_data);
    //myPort.write("this is sent to mcu" + "\n");
    client.publish("grupp4/direction/remote_2", read_data + '\n'); //publish data [TOPIC, MESSAGE, OPTIONS]
...
let topic_s ="grupp4/range/car_2";                 //topic with name "avr"
...
myPort.write(message);  // <-- 'A' is sent to UART!
});
...
client.publish("grupp4", "message" , options_P);*/
